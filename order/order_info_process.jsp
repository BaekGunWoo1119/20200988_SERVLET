...
<%
    ...
    Cookie addressName1 = new Cookie("Shipping_addressName1", URLEncoder.encode(request.getParameter("addressName1"), "utf-8"));
	...
	addressName1.setMaxAge(24 * 60 * 60);
    ...
    response.addCookie(addressName1);
